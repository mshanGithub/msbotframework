...
{
	$fileContent = $fileContent + "`r`n[assembly: AssemblyKeyFileAttribute(@`"\\cp1pd2cdscvlt01\Public\StrongNamePublicKeys\35MSSharedLib1024.snk`")] `r`n [assembly: AssemblyDelaySignAttribute(true)]"
	return $fileContent
}
