...
namespace Microsoft.Bot.Sample.AspNetCore.Simple.Controllers
{
    ...
    public class MessagesController : Controller
    {
        ...
        // POST api/values
        [HttpPost]
        // Uncommented the Authorize filter if already have
        // the Microsoft App ID and the Password Keys
        //[Authorize(Roles = "Bot")]
