...
namespace Microsoft.Bot.Connector
{
    ...
    public static partial class ConversationsExtensions
    {
            ...
            /// </param>
            public static ConversationsResult GetConversations(this IConversations operations, string continuationToken = default(string))
            {
                return operations.GetConversationsAsync(continuationToken).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static void DeleteConversationMember(this IConversations operations, string conversationId, string memberId)
            {
                operations.DeleteConversationMemberAsync(conversationId, memberId).GetAwaiter().GetResult();
            }
