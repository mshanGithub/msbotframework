...
msbuild /property:Configuration=release Microsoft.Bot.Connector.Abstractions.csproj
for /f %%v in ('powershell -noprofile "(Get-Command .\bin\release\Microsoft.Bot.Connector.Abstractions.dll).FileVersionInfo.FileVersion"') do set version=%%v
