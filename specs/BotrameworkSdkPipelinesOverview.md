...
For a list of pipelines see the [Bot Framework SDK Pipelines List document](https://github.com/microsoft/botframework-sdk/blob/v-bruhal/pipelinedoc/specs/SdkPipelinesList.md).
